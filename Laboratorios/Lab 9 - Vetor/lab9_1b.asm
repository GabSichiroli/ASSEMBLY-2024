...
VOLTA PROC
      ...
      VOLT: 
            MOV  DL, VETOR[BX]      ;Insere o valor do elemento de determinada posição do vetor em DL, a posição do vetor é determinado pelo valor de BX, OU SEJA VETOR[0],VETOR[1]...VETOR[6]
